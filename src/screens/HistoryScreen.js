...
export default function HistoryScreen({ navigation }) {
  ...
  if (startDate != "ตั้งแต่" && endDate != "ถึง") {
      ...
      <View style={{ marginLeft: 20, flexDirection: "row" }}>
        ...
        >
          {!itemData.image ? (
            ...
            <Image style={styles.tinyLogo} source={{ uri: itemData.image }} />
          )}
        </View>
        <View
          style={{
    ...
    <View style={styles.container}>
      ...
      <DataTable>
        <DataTable.Header style={{ zIndex: 0 }}>
          ...
          <DataTable.Title style={{ justifyContent: "center" }}>
            <Text style={{ fontSize: 18, fontWeight: "bold" }}>เวลาที่ทาน</Text>
          </DataTable.Title>
          <DataTable.Title style={{ justifyContent: "center" }}>
            <Text style={{ fontSize: 18, fontWeight: "bold" }}>ชื่อของยา</Text>
          </DataTable.Title>
          <DataTable.Title style={{ justifyContent: "center" }}>
